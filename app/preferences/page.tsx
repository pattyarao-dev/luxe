...
/*
"Shopping", "This is a long text", "Travel", "Leisure",
    "Shopping", "Dining", "Travel", "Leisure","Shopping", "Dining", 
    "Travel", "Leisure", "WrayNathanAndres", "Patty"
*/
  ...
  return (
    <main className="w-full min-h-screen p-8 flex items-start justify-center flex-col gap-10 gradient-background">
       <div>
