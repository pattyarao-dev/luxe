        ...
        if(data.user_type === "ADMIN_ALL"){
            ...
            output = await Promise.all(brands.map(async (brand) => {
                ...
                for (let reward of temp_rewards) {
                    ...
                    for (let bucketid of reward.claim_buckets) {
                        ...
                        if (data.start_date === '' && data.end_date === '') {
                            ...
                            if (reward.reward_type === "DISCOUNT") {
                                temp_discount += bucket_content.bucket_claim_count;
                            } else {
                                temp_freebies += bucket_content.bucket_claim_count;
                            }
                        } else {
                    ...
                    console.log(reward.reward_name, "disc val: ", temp_discount, "freebie val: ", temp_freebies)
                }
